...
exports.FIELDS_MAP = void 0;
exports.diffSplice = diffSplice;
exports.bindLww = bindLww;
exports.bindText = bindText;
/** The map share holding the LWW entries; text shares live at `fields/<name>`. */
exports.FIELDS_MAP = "fields";
/**
 ...
 */
function diffSplice(oldValue, newValue) {
...
function bindLww(doc, name, control) {
    const map = doc.getMap(exports.FIELDS_MAP);
    const origin = {};
...
function bindText(doc, name, control) {
    const text = doc.getText(`${exports.FIELDS_MAP}/${name}`);
    const origin = {};
